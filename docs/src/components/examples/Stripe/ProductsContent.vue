  ...
  <div>
    <div class="flex">
      <div class="primary p-30">
        <div v-for="i in 2" :key="`g1-${i}`">
          <base-text :max="200" type="title" />
          <base-group v-for="j in 3" :key="`g1-${i}-${j}`" />
          <br />
        </div>
      </div>
      <div class="secondary p-30">
        <div v-for="i in 3" :key="`g3-${i}`">
...
import BaseGroup from '../../base/BaseGroup.vue';
